<div class="panel panel-default">
        ...
        <div class="col-md-12">
          <div>
            ...
            <div class="well">
              ...
              <a href="/admin/education/programs/{{ .program.GetID }}/advance-options/modify-static-description" class="btn btn-primary">Modify static description</a>
            </div>
          </div>
          <div>
            <h2>Details</h2>
  ...
  <script src="/static/js/admin/education/program/advance-options.js"></script>
  <script>
  $(document).ready(function(){
      var module = wisply.getModule("admin-education-program-advance-options"),
