	...
	ns := beego.NSNamespace("/programs",
		beego.NSNamespace("/:program",
			...
			beego.NSNamespace("/ka",
				beego.NSNamespace("/add",
					beego.NSRouter("", &program.KA{}, "GET:ShowAddForm"),
					beego.NSRouter("", &program.KA{}, "POST:CreateKA"),
				),
				beego.NSNamespace("/:ka",
					beego.NSNamespace("/modify",
						beego.NSRouter("", &program.KA{}, "GET:ShowModifyForm"),
						beego.NSRouter("", &program.KA{}, "POST:Update"),
					),
					beego.NSNamespace("/delete",
						beego.NSRouter("", &program.KA{}, "POST:Delete"),
					),
				),
			),
		),
