            ...
            <form action="{{.actionURL}}" method="{{.actionType}}" class="form-horizontal" >
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{.sourceName}}" class="form-control" name="source-name" id="source-name" placeholder="Name" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="source-URL" class="col-lg-2 control-label">URL</label>
                        <div class="col-lg-10">
                            <input type="url" value="{{.sourceUrl}}" class="form-control" name="source-URL" id="source-URL" placeholder="URL address" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="source-description" class="col-lg-2 control-label">Description</label>
                        <div class="col-lg-10">
                            <textarea value="{{.sourceDescription}}" class="form-control" rows="3" name="source-description" id="source-description"></textarea>
