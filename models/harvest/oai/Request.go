...
// Perform an HTTP GET request, reads the body of the request and returns it
func (request *Request) Perform() ([]byte, error) {
	var (
		content []byte
	)
	...
	if err != nil {
		return content, errors.New("There was a problem while trying to connect to that address: " + err.Error())
	}
	...
	if err != nil {
		return content, errors.New("There was a problem while trying to read the content of the page: " + err.Error())
	}
	return content, nil
}
...
func (request *Request) Parse(body []byte) (*Response, error) {
	...
	if err != nil {
		return response, errors.New("There was a problem while trying parsing the request: " + err.Error())
	}
	return response, nil
}
