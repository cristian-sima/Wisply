    ...
    <div class="col-lg-12 col-md-12 col-sm-12" >
      <div class="panel panel-default">
        ...
        <article class="panel-body">
          ...
          Wisply is gathering data from different repositories. Therefore, Wisply is not aware of the resources or any other piece of data from these.<br /><br />

          If you are of the opinion that a work within Wisply:
          <ul>
            <li>
