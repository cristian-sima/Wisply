      ...
      <div class="panel panel-default">
          ...
          <div>
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <hr />
                <img class="img-responsive" src="/static/img/developer/cloud.png" alt="developer &amp; Developers" />
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6">
                <br />
                <br />
        ...
        <section>
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <br />
              You can integrate data from Wisply with your application. Wisply makes available a API developer which you can use.
              <br />
              <br />
              <ul class="list-group">
