      ...
      <div class="col-lg-4 col-md-5 col-sm-5">
         <div class="panel panel-info" >
            <div class="panel-heading">
               <h3 class="panel-title">Cookies Policy Contents</h3>
            </div>
         ...
         <div class="panel panel-default">
            ...
            <section class="panel-body">
               ...
               <article>
                  ...
                  <p>
                  <p>We allow Google to place cookies on Wisply. We reserve the right to add additional cookies at any point in the future.</p>
                  <p>If you want to read more about what type of data we are collecting, please go to our <a href="/privacy">Privacy Policy</a></p>
               </article>
               <article>
                  ...
                  <p>Please remember that if you decide to disable cookies, you may not take advantage of all functions provided by Wisply.
                  <p>
               </article>
            </section>
         </div>
