	...
	adminCurriculumNS := beego.NSNamespace("/curriculum",
		...
		beego.NSNamespace("/programs/:id",
			...
			beego.NSNamespace("/advance-options",
				...
				// beego.NSNamespace("/modify",
				// 	beego.NSRouter("", &admin.Curriculum{}, "GET:Modify"),
				// 	beego.NSRouter("", &admin.Curriculum{}, "POST:Update"),
				// 	beego.NSNamespace("/filter",
				// 		beego.NSRouter("", &admin.Curriculum{}, "GET:ShowFilter"),
				// 		beego.NSRouter("", &admin.Curriculum{}, "POST:ChangeFilter"),
				// 	),
				// ),
			),
			// beego.NSNamespace("/empty",
			// 	beego.NSRouter("", &admin.Curriculum{}, "POST:EmptyRepository"),
			// ),
			// beego.NSNamespace("/delete",
			// 	beego.NSRouter("", &admin.Curriculum{}, "POST:Delete"),
			// ),
		),
		beego.NSNamespace("add",
