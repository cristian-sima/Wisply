<div class="panel panel-default">
	...
	<div class="panel-body">
		<form method="{{.actionType}}" class="form-horizontal"> {{ .xsrf_input }} {{ $safeDescription := .institutionDescription|html}}
			<fieldset>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" value="{{.institutionName}}" class="form-control" name="institution-name" id="institution-name" placeholder="Name" required pattern=".{3,255}" title="The name has 3 up to 255 characters!"> </div>
				</div>
        ...
        <div class="form-group text-center" style="min-height:80px">
              ...
              <span class="description-modified hideMe"><span class="text-warning"> <span class="glyphicon glyphicon-warning-sign"></span> Description modified</span> <span class="text-danger"><span id="discard-description-changes" data-toggle="tooltip" data-placement="top" title="Discard changes" class="hover glyphicon glyphicon-remove"></span></span>
						</span>
				...
				<div class="hideMe" id="wiki-source-div">
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="url" value="" class="form-control" name="institution-wikiURL" id="institution-wikiURL" placeholder="Wiki address" pattern=".{3,2083}" title="The wiki URL has 3 up to 2083 characters!"> </div>
					</div>
          <div class="form-group">
						<label for="institution-logoURL" class="col-lg-2 control-label">Logo Address</label>
						<div class="col-lg-10">
							<input type="url" value="" class="form-control" name="institution-logoURL" id="institution-logoURL" placeholder="Logo address" pattern=".{3,2083}" title="The wiki URL has 3 up to 2083 characters!"> </div>
					</div>
				</div>
        {{ if eq .action "Add" }}
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="url" value="{{.institutionUrl}}" class="form-control" name="institution-URL" id="institution-URL" placeholder="URL address" required pattern=".{3,2083}" title="The URL has 3 up to 2083 characters!"> </div>
				</div>
         {{ end }}
				<div class="form-group">
					<div class="col-lg-10 col-lg-offset-2">
						<input type="submit" class="btn btn-primary" value="Submit" /> <a href="/admin/institutions" class="btn btn-default">Cancel</a> </div>
				</div>
			</fieldset>
		</form>
	</div>
