...
//
// (ignored) The first tag output is an XML declaration where the version is always 1.0 and the encoding is always UTF-8, eg: <?xml version="1.0" encoding="UTF-8" ?>
...
// - (Identify, ListMetadataFormats, ListSets, GetRecord, ListIdentifiers, ListRecords) an element with the same name as the verb of the respective OAI-PMH request.
//
