<div class="panel panel-default">
	<div class="panel-heading" style="padding-bottom:0px">
		<ul class="breadcrumb">
			...
			<li><a href="/admin/developers">Developers &amp; Research</a></li>
	...
	<div class="panel-body">
		<form method="POST" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
				Table <a href="/developer/data/table"><strong>{{ .table.Name }} </strong></a>
				</div>
			</div>
			{{ end }}
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<textarea class="form-control" name="table-description" id="table-description" placeholder="Description" title="The name has 3 up to 1000 characters!">{{ .table.GetDescription }}</textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-lg-10 col-lg-offset-2">
						<input type="submit" id="institution-submit-button" class="btn btn-primary" value="Submit" /> <a href="/admin/developers" class="btn btn-default">Cancel</a> </div>
					</div>
				</fieldset>
			</form>
		</div>
