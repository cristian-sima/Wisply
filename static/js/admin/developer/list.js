 ...
 */
/**
 * @namespace AdmindeveloperModule
 */
var AdmindeveloperModule = function() {
	'use strict';
	/**
	 * The constructor saves the id and the name
	 * @class Table
	 * @memberof AdmindeveloperModule
	...
	List.prototype =
		/** @lends AdmindeveloperModule.List */
		{
			/**
...
$(document).ready(function() {
	"use strict";
	var module = new AdmindeveloperModule();
	wisply.loadModule("admin-developer", module);
});
